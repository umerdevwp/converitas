...
<html>
    ...
    <body>
        ...
        <div id="show-policy" class="content scaffold-show" role="main">
            ...
            <f:display bean="policy" />
            <g:form resource="${this.policy}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.policy}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
