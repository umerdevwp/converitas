...
<div id="g6-text-container" style="display:none; width: 500px; background:#3f3f3f3; border: 2px solid #333333;padding:5%;">Alpha Beta</div>
...
%{--    <script src="/assets/wordcloud.js"></script>--}%
    ...
    <script src="/assets/map-library.js"></script>
