...
<html>
    ...
    <body>
        ...
        <div id="show-relationship" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.relationship}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.relationship}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
