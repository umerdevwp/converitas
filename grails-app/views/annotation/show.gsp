...
<html>
    ...
    <body>
        ...
        <div id="show-annotation" class="content scaffold-show" role="main">
            ...
            <f:display bean="annotation" />
            <g:form resource="${this.annotation}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.annotation}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
